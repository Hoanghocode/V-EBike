...
Route::get('lang/{locale}', function ($locale) {
    if (! in_array($locale,['vi','en','cn','jp'])){
        abort(404);
    }
...
//ĐẲ BÀN
Route::post('/book-order','App\Http\Controllers\CheckoutController@book_order');
...
Route::get('/add-user','App\Http\Controllers\UserController@add_users');
...
//đặt bàn
Route::get('/book','App\Http\Controllers\CheckoutController@book');