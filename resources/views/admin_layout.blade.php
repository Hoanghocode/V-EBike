        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-brand')}}">Thêm cơ sở</a></li>
						<li><a href="{{URL::to('/all-brand')}}">Liệt kê cơ sở</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/user')}}">Liệt kê người dùng</a></li>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2024 Visitors. All rights reserved | Design by <a href="http://w3layouts.com">Đặng văn hiểu</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
