                ...
                <div class="col-sm-10 clearfix">
                    ...
                    <div class="bill-to">
                        ...
                        <div class="form-one">
                            ...
                            <form method="post" >
                                @csrf
                                <input required type="text" name="shipping_email" class="shipping_email" data-validation="email*" data-validation-error-msg="làm ơn điền đúng email"  placeholder="Email*">
                                <input required type="text" name="shipping_name" class="shipping_name" placeholder="Họ và tên*">
                                <input required type="text" name="shipping_address" class="shipping_address" placeholder="địa chỉ*">
                                <input required type="text" name="shipping_phone" class="shipping_phone" placeholder="điện thoại*">
                                <textarea required name="shipping_notes" class="shipping_notes"  placeholder="ghi chú đơn hàng của bạn*" rows="5"></textarea>
