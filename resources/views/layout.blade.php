...
<head>
	...
	<link rel="shortcut icon" type="image/png" href="{{asset('/public/frontend/images/home/logo1.jpg')}}"/>
					...
					<div class="col-sm-4">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 0977378715</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> nhahangvanhieu@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-2">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{URL::to('/')}}"><img class="hieu" src="{{asset('public/frontend/images/home/logo.jpg')}}" alt="" /></a>
						</div>
						<div class="btn-group pull-right">
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a @selected(true) href="{{url('lang/vi')}}">Tiếng Việt</a></li>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
							   ...
							   ?>
								<li><a  href="{{URL::to('/book')}}"><i class="fa fa-bookmark" aria-hidden="true"></i> @lang('language.book')</a></li>
								<?php 
								
								}else {
								   ?>
								<li><a href="{{URL::to('/login-checkout')}}"><i class="fa fa-bookmark" aria-hidden="true"></i> @lang('language.book') </a></li>
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<div class="search_box pull-right">
							<input type="text" style="width:100%;" name="keywords_submit" id="keywords" placeholder="tìm kiếm đồ ăn"/>
...
{{-- slider	 --}}
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2024 Đặng Văn Hiểu</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="">Đặng Văn Hiểu</a></span></p>
				</div>
			</div>
		</div>
          ...
          $(document).ready(function(){
            $('.book_order').click(function(){
                swal({
                  ...
                  text: "Bạn hãy chắc chắn giúp tôi khi đặt bàn,bạn có muốn đặt không?",
                  type: "warning",
                  showCancelButton: true,
                  confirmButtonClass: "btn-danger",
                  confirmButtonText: "Cảm ơn, Đã đặt bàn",
                    cancelButtonText: "Đóng,chưa Đặt",
                    closeOnConfirm: false,
                    closeOnCancel: false
                },
                function(isConfirm){
                     if (isConfirm) {
                        ...
                        var short_select = $('.short_select').val();
                        ...
                        $.ajax({
                            ...
                            success:function(){
                               swal("đặt bàn", "Bàn của bạn đã được đặt thành công", "success");
							   window.setTimeout(function(){ 
                            location.reload();
                        } ,3000);
                            }
                        ...
                        swal("Đóng", "Bàn chưa được đặt, làm ơn hoàn tất việc đặt bàn", "error");
